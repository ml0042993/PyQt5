...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(771, 479)
        self.centralWidget = QtWidgets.QWidget(MainWindow)
        self.centralWidget.setObjectName("centralWidget")
        self.scrollArea = QtWidgets.QScrollArea(self.centralWidget)
        self.scrollArea.setGeometry(QtCore.QRect(9, 9, 511, 371))
        ...
        item_0 = QtWidgets.QTreeWidgetItem(self.treeFiles)
        item_1 = QtWidgets.QTreeWidgetItem(item_0)
        self.treeFiles.header().setDefaultSectionSize(100)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/images/824.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/images/delete1.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actTree_DeleteItem.setIcon(icon2)
        self.actTree_DeleteItem.setObjectName("actTree_DeleteItem")
        self.actTree_ScanItems = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/images/fold.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actTree_ScanItems.setIcon(icon3)
        self.actTree_ScanItems.setObjectName("actTree_ScanItems")
        self.actClose = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/images/exit.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actZoomRealSize.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/images/424.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actZoomFitW.setIcon(icon8)
        self.actZoomFitW.setObjectName("actZoomFitW")
        self.actZoomFitH = QtWidgets.QAction(MainWindow)
        self.actZoomFitH.setEnabled(False)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/images/426.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actZoomFitH.setIcon(icon9)
        ...
        self.actDockVisible.setIcon(icon7)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/images/814.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actDockFloat.setIcon(icon10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeFiles.topLevelItem(1).setText(0, _translate("MainWindow", "分组2"))
        self.treeFiles.topLevelItem(1).child(0).setText(0, _translate("MainWindow", "图片2"))
